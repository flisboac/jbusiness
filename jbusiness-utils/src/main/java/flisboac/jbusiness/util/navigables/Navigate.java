...
import flisboac.jbusiness.util.Immutable;
...
public final class Navigate implements Serializable, Navigation, Immutable {
    ...
    public static Navigate relative(Number amount) {
        Objects.requireNonNull(amount, "amount cannot be null for relative navigation.");
    ...
    public static Navigate absolute(Number index) {
        Objects.requireNonNull(index, "index cannot be null for absolute navigation.");
